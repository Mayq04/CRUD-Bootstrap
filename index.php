...
<html lang="en">
  <head>
	...
	<link rel="shorcut icon" href="assets/images/favicon_.png" type="image/ico" />

    <title> Sistem Informasi Akademik UTS </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php"><span><font size="4.95" color="white" face="Helvetica Neue">    APLIKASI AKADEMIK</font></span></a>
            </center>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/image_.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Mar'i Yustiardin</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/image_.jpg" alt="">Mar'i Yustiardin
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Aplikasi Akademik : Mar'i Yustiardin
          </div>
          <div class="clearfix">Tekniik Informatika 2020</div>
        </footer>
        <!-- /footer content -->
      </div>
    </div>
